...
void Adafruit_CAP1188::setSensitivity(int sensitivity){
  ...
  switch (sensitivity) {
    ...
    //least sensitive
    case 1:
      this->writeRegister(CAP1188_SENSITIVITY,0x7F);
      break;

    case 2:
      this->writeRegister(CAP1188_SENSITIVITY,0x6F);
      break;

    case 3:
      this->writeRegister(CAP1188_SENSITIVITY,0x5F);
      break;

    case 4:
      this->writeRegister(CAP1188_SENSITIVITY,0x4F);
      break;

    case 5:
      this->writeRegister(CAP1188_SENSITIVITY,0x3F);
      break;

    case 6:
      this->writeRegister(CAP1188_SENSITIVITY,0x2F);
      break;
    //most sensitive
    case 7:
      this->writeRegister(CAP1188_SENSITIVITY,0x1F);
      break;
  }
